...
namespace Unite
{
    ...
    {
        public readonly static TimeSpan DefaultTimeSpan = TimeSpan.FromDays(10);
        ...
        public static void Init(string conn, string prefix)
        {
        ...
        /// </summary>
        /// <param name="redisKey">The key of the string.</param>
        /// <param name="redisValue">The amount to increment by (defaults to 1).</param>
        /// <returns></returns>
        public long StringIncrement(string redisKey, long redisValue=1)
        {
            redisKey = AddKeyPrefix(redisKey);
            return _db.StringIncrement(redisKey, redisValue);
        }
